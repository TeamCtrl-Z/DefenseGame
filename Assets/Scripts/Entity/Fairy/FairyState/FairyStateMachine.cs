...
public class FairyStateMachine : StateMachine<FairyController>
{
    ...
    /// </summary>
    public FairyAttackHandler AttackHandler { get; private set; }
    ...
    /// <param name="attackHandler">Fairy의 FairyAttackHandler</param>
    public FairyStateMachine(FairyController sender, Animator animator, IBattleStatus battleStatus, FairyAttackHandler attackHandler) : base(sender)
    {
        Animator = animator;
